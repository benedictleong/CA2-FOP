...
do {
    ...
    if(reply == 2) {
            ...
            if(isvalidName == true) {
                ...
                do {
                    ...
                    if(istimeNumber == false) {
                        ...
                        //add in values
                        var replyRating = [];
                        movieList.push(new Movie(replyName,replyGenre2,replyreleaseDate,replyrunningTime,replyRating));
                        break;
                    }
                } while(reply == 2);
                break;
        ...
        do {
            ...
            var movie_choice = input.questionInt(movieList.length+1+") Go back to Main Menu\n>> ");
            if (movie_choice > movieList.length+1 || movie_choice < 1){
                error = true;
            ...
            do{
                var error = false;
                var rating_input = input.questionInt('Enter your rating for "'+movieList[movie_choice - 1].name+'" (1 to 5 inclusive): ');
